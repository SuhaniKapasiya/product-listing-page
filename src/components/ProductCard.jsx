        ...
        <div className="flex justify-center gap-5 items-center w-full mt-5">
          ...
          {isInCart ? (
            <button
             ...
             text-[10px] p-1 px-2 uppercase hover:bg-red-700 hover:text-white transition duration-300 ease-in w-[60px] h-[60px]"
            >
              Remove from Cart
            </button>
          ) : (
            <button
             ...
             text-[10px] p-1  px-2 uppercase hover:bg-green-700 hover:text-white transition duration-300 ease-in w-[60px] h-[50px]"
            >
              Add to Cart
            </button>
          )}
